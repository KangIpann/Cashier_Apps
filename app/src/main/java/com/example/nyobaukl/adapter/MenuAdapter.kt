...
import com.example.nyobaukl.menu.UbahMenu
...
class MenuAdapter(private var menuList: List<dataMenu>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MenuViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.data_menu_list, parent, false)
    ...
    override fun onBindViewHolder(holder: MenuViewHolder, position: Int) {
        ...
        holder.btnUbah.setOnClickListener {
            ...
            val intent = Intent(context, UbahMenu::class.java)
    ...
    fun setMenuList(menuList: List<dataMenu>) {
